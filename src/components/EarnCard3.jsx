...
const EarnCard3 = ({er}) => {
  return (
    <section className='h-full border-[#4a4a4a] border-[1px] rounded-[5px] bg-[#151515]'>
      ...
      <div className='w-full items-center  flex flex-row pt-[12px] pl-[13px] gap-[10px]'>
      <button className='px-[15px] py-[6px] bg-[#4ec499] hover:bg-[#207A59] text-[white] text-[13px] rounded-[3px]'>{er.button1}</button>
      <button className='px-[15px] py-[6px] bg-[#4ec499] hover:bg-[#207A59] text-[white] text-[13px] rounded-[3px]'>{er.button2}</button>
      </div>
